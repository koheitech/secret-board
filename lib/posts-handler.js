...
const oneTimeTokenMap = new Map(); // associated array {key: userName: value: token}
...
/**
   * return value if trackingID in Cookie is valid
   * create new Cookie and return that if Cookie not existed or invalid
